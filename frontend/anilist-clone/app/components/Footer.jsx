...
const Footer = () => {
  return (
    <footer className="bottom-0 left-0 right-0 z-10 bg-[#11161d] bg-opacity-90 h-64 flex items-center px-6">
      <div className="footer__container flex justify-end w-full">
        <div className="footer__container__left mr-6">
          <ul className="footer__container__right__list">
            <li className="footer__container__right__list__item text-white">
              Donate
            </li>
            <li className="footer__container__right__list__item text-white">
              AniList.co
